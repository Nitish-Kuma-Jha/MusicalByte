...
//   const {onToggleMute, onToggleLoop, onToggleShuffle, onChangeSpeed, onVolumeChange, } = playerFeatures;
...
//         {/* Mute */}
//         <button className="features-btn" aria-label={isMuted ? "unmute" : "mute"} onClick={onToggleMute}>
//           {isMuted ? (
...
//           style={{
//             background: `linear-gradients(to right, #q855f7 ${volume * 100}%, #333 ${volume * 100}%)`,
//           }}
//           readOnly
//         />
//       </div>
